...
import { 
  ...
  Rocket, Sparkles, Crown, Diamond, Flame,
  Brain, Cpu as CpuIcon, ChartLine, ChartBar, ChartScatter, ChartPie,
  Timer, Cloud, Sun, Moon, Heart, ThumbsUp, ThumbsDown,
  MessageCircle, MessageSquare, Send, PhoneCall,
  ...
  Building, Truck, Car, Bus, Train, Plane,
  Compass, Map, Navigation, Anchor,
  Fish, Bird, Dog, Cat, Trees, Flower, Leaf,
  Mountain, MapPin as MapPinIcon, Navigation as NavigationIcon,
  Ship,
  Loader2
} from "lucide-react";
